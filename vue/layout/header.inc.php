...
<head>
    ...
    <link rel="stylesheet" media="(min-width:767px) and (max-width: 1000px)" href="assets/css/style_small.css"
          type="text/css"/>
    <link rel="stylesheet" media="(min-width:480px) and (max-width: 767px)" href="assets/css/style_tab.css"
          type="text/css"/>
    <link rel="stylesheet" media="(min-width:350px) and (max-width: 480px)" href="assets/css/style_phone.css"
          type="text/css"/>
    <link rel="stylesheet" media="(min-width:1000px) and (max-width: 1281px)" href="assets/css/style_moyen.css"
          type="text/css"/>
</head>
<body>
    ...
    <header id="header" class="col_24 ombrage">
        ...
        <div id="cosearch" class="col_6 suffix_1">
            <form class="search petit" name="formulaire" method="post" action="?module=page&amp;action=recherche">
                <input class="encarsearch" type="text" placeholder=" Rechercher un jeu, des actus ..." name="recherche"
                       id="recherche" required="required">
