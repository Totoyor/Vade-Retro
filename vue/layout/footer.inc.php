        ...
        <div id="footer1" class="col_24">
            ...
            <div class="col_7 menufooter" >
                <div  class="prefix_5 menufooter">
                  <ul id="menu2" class="listtext2 red petit">
                     ...
                     <li class="ultimli">
                      ...
                      <li ><a href="?module=page&amp;action=mentionlegale"><span>Mentions Légales</span></a>
                        </li>
                 </ul>          
                ...
                <ul id="menu1" class="listtext2 blueC">
                  <li><a href="?module=page&amp;action=index"><span>Accueil</span></a>
                  </li>

                  <li><a href="?module=page&amp;action=apropos"><span>À propos</span></a>
                    </li>

                  <li ><a href="?module=packs&amp;action=index"><span>Packs</span></a>
                    </li>
                     <li ><a href="?module=jeux-video&amp;action=index"><span>Jeux-Vidéo</span></a>
                    </li>

                    <li><a href="?module=page&amp;action=rachat"><span>Rachat</span></a>
                    </li>
                     <li ><a href="?module=blog&amp;action=index"><span>Blog</span></a>
                    </li>

                    <li><a href="?module=page&amp;action=contact"><span>Contact</span></a>
                    </li>
        ...
        <div id="blog" class="col_10 ombrage" >
            ...
            <h2 id="titreblog" class="center moyen">SUIVEZ NOTRE BLOG</h2>
                ...
                <div>
                  ...
                  <?php  }
                        elseif (isset($_GET["m"]) == 'ajoutemailnok')   { ?>
                        <p class="center red">
                            Email non valide.
                        </p>
                        <?php } ?>
                    ...
                    <form class="search" name="formulaire" method="post" action="?module=newsletter&amp;action=newsletter">
                        <input class="encarsearch" id="nexletter" type="email" placeholder=" Votre adresse email" name="user_email" required="required" maxlength="45">
                    ...
                    <div id="articleall">
                        ...
                        <div id="article" class="col_18"> 
                            ...
                            <p class="padding petit securetab">
                                Elle est présentée comme la machine ultime pour les possesseurs d'anciens jeux Super Nintendo, NES et Megadrive. Mais la machine réserve de nombreuses désillusions.
                            </p>
                            ...
                            <div id="encartwi" class="prefix_2 col_20 suffix_2 encartwi">  
                                <div id="securtwi">
                                   ...
                                   <blockquote class="twitter-tweet center petit" lang="fr">
                                    ...
                                    <a href="https://twitter.com/_VRgaming/status/551776823022219265"><p class="center petit padding">4 Janvier 2015 
                                        </p>
                                    </a>
                                    </blockquote>
