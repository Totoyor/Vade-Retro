        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Formulaire Modification Catégorie
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <?php if(isset($_GET["m"])) {
                    ...
                    <strong>Catégorie Modifiée !</strong> Vous avez correctement modifié la catégorie dans la base de données.
                </div>     
                  <?php } 
                        elseif ($_GET["m"] == "nok") { ?>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <form role="form" action="?module=blog&action=modif_categorie&id=<?php echo $catModif[0] ?>&modif=<?php echo $catModif[0] ?>" method="post">

                            <div class="form-group">
                                <label for="nom">Titre de la catégorie :</label>
                                <input class="form-control" required="required" name="nom" value="<?php echo $catModif[1] ?>">
