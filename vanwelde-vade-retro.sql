...
--
-- Client :  localhost
-- Généré le :  Mer 17 Juin 2015 à 17:04
...
(1, 'Vanwelden', 'Thomas', 'vanweldenthomas@live.fr', 'f71dbe52628a3f83a77ab494817525c6', '2015-03-16 11:28:27'),
(2, 'Louveau', 'Antonia', 'antonia.louveau@gmail.com', '3947c94100c4d24c41ee5faf8b757138', '2015-03-16 16:38:11'),
(3, 'Simon', 'Julien', 'simon.julien20@gmail.com', '11aad936ee5aab81953eee2e59fda247', '2015-03-16 16:38:39'),
(4, 'Mimault', 'Nicolas', 'nmimault@gmail.com', '3a2cf27458c9aa3e358f8fc0f002bff6', '2015-03-16 16:39:05'),
(5, 'Periquet', 'Florian', 'florian08.periquet@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2015-03-16 17:45:34'),
...
CREATE TABLE IF NOT EXISTS `vr_blog_articles` (
...
CREATE TABLE IF NOT EXISTS `vr_blog_articles_has_vr_blog_categorie` (
...
CREATE TABLE IF NOT EXISTS `vr_blog_categorie` (
`id_blog_categorie` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vr_blog_comment` (
...
CREATE TABLE IF NOT EXISTS `vr_commandes` (
...
--
-- Contenu de la table `vr_commandes`
--

INSERT INTO `vr_commandes` (`id_commande`, `ref_commande`, `montant_commande`, `qt_commande`, `livraison_commande`, `date_commande`, `validation_commande`, `vr_user_id_user`, `vr_prod_console_id_console`) VALUES
(1, '97658', 182, 1, '', '2015-03-16 17:38:50', NULL, 1, 2),
(2, '14760', 149, 1, '', '2015-03-17 19:01:11', NULL, 2, 6),
(3, '16917', 241, 1, '', '2015-03-18 18:00:53', NULL, 3, 1),
(4, '17685', 330, 1, '', '2015-03-19 14:12:58', NULL, 4, 1),
(5, '28297', 169, 1, '', '2015-03-19 17:10:15', NULL, 6, 6),
(6, '83624', 116, 1, '', '2015-03-19 18:03:19', NULL, 2, 6),
(7, '92567', 116, 1, '', '2015-03-19 18:03:47', NULL, 2, 6),
(8, '18796', 132, 1, '', '2015-03-19 18:47:33', NULL, 2, 6),
(9, '17866', 33, 1, '', '2015-03-19 20:08:45', NULL, 2, 4),
(10, '34586', 33, 1, '', '2015-03-19 20:17:22', NULL, 2, 4),
(11, '12056', 94, 1, '', '2015-03-20 02:12:31', NULL, 7, 7),
(12, '20261', 143, 1, '', '2015-03-20 09:52:11', NULL, 2, 2),
(13, '15951', 191, 1, '', '2015-03-20 09:57:15', NULL, 2, 5),
(14, '20749', 149, 1, '', '2015-03-20 10:48:58', NULL, 2, 2),
(15, '20090', 176, 1, '', '2015-03-20 12:15:38', NULL, 8, 2);
...
CREATE TABLE IF NOT EXISTS `vr_commandes_has_vr_prod_jeux` (
...
CREATE TABLE IF NOT EXISTS `vr_contact` (
...
--
-- Contenu de la table `vr_contact`
--

INSERT INTO `vr_contact` (`id_contact`, `nom_contact`, `prenom_contact`, `mail_contact`, `objet_contact`, `message_contact`, `date_contact`) VALUES
(1, 'Albert', 'Supontel', 'albert@email.fr', 'Bonjour Monsieur', 'Je vous contacte pour une demande de remboursement.\r\n\r\nCordialement,\r\nAlbert', '2015-03-19 14:57:56'),
(2, '', '', '', '', '', '2015-03-19 16:03:59'),
(3, '', '', '', '', '', '2015-03-19 16:06:21');
...
CREATE TABLE IF NOT EXISTS `vr_newsletter` (
...
--
-- Contenu de la table `vr_newsletter`
--

INSERT INTO `vr_newsletter` (`id_newsletter`, `email_newsletter`, `date_newsletter`) VALUES
(1, 'nmimault@gmail.com', '2015-03-16 17:37:54'),
(2, 'vanweldenthomas@live.fr', '2015-03-16 17:46:49'),
(3, 'nico@mail.fr', '2015-03-18 14:53:13'),
(4, 'antonia.louveau@gmail.com', '2015-03-18 17:59:58'),
(5, 'etiennelepetit92@gmail.com', '2015-03-19 14:12:10'),
(6, 'florian08.periquet@gmail.com', '2015-03-19 15:56:24'),
(7, 'chap@mail.fr', '2015-03-19 17:08:41'),
(8, 'weyoz.dev@gmail.com', '2015-03-20 02:11:35'),
(9, 'florian.periquet@etudiant-eemi.com', '2015-03-20 10:52:24');
...
CREATE TABLE IF NOT EXISTS `vr_prod_console` (
...
CREATE TABLE IF NOT EXISTS `vr_prod_jeux` (
...
CREATE TABLE IF NOT EXISTS `vr_rachat` (
`id_rachat` int(11) NOT NULL,
...
--
-- Contenu de la table `vr_rachat`
--

INSERT INTO `vr_rachat` (`id_rachat`, `nom_rachat`, `prenom_rachat`, `mail_rachat`, `adresse_rachat`, `ville_rachat`, `cp_rachat`, `pays_rachat`, `tel_rachat`, `objet_rachat`, `message_rachat`, `etat_rachat`, `img_rachat`, `date_rachat`) VALUES
(1, 'Astier', 'Alexandre', 'astieralex@mail.fr', 'astieralex@mail.fr', 'Poitier', 67908, 'France', 654326798, 'Nintendo 3D', 'Une belle nintendo 3D, combien serez-vous prêt à ma la racheter ?\r\n\r\nAlexandre', 'Bon', NULL, '2015-03-18 16:28:13'),
(2, '', '', '', '', '', 0, 'France', 0, '', '', 'Bon', NULL, '2015-03-19 16:08:46');
...
CREATE TABLE IF NOT EXISTS `vr_user` (
...
--
-- Contenu de la table `vr_user`
--

INSERT INTO `vr_user` (`id_user`, `civilite_user`, `nom_user`, `prenom_user`, `mail_user`, `password_user`, `adresse_user`, `ville_user`, `cp_user`, `pays_user`, `tel_user`, `adresse_livraison_user`, `ville_livraison_user`, `cp_livraison_user`, `pays_livraison_user`, `validation_user`, `date_user`) VALUES
(1, NULL, 'Mimault', 'Nicolas', 'nmimault@gmail.com', '3a2cf27458c9aa3e358f8fc0f002bff6', NULL, NULL, NULL, NULL, 689898989, '35mljmrgj', 'Paris', 75014, 'France', NULL, '2015-03-16 17:37:54'),
(2, 'Mr.', 'Vanwelden', 'Thomas', 'vanweldenthomas@live.fr', 'f71dbe52628a3f83a77ab494817525c6', 'Rue des capucins', 'Hem', 59600, 'console1', 631972605, '36 rue de la paix', 'Villeneuve d''Ascq', 59491, 'France', NULL, '2015-03-16 17:46:49'),
(3, NULL, 'Louveau', 'Antonia', 'antonia.louveau@gmail.com', '3947c94100c4d24c41ee5faf8b757138', NULL, NULL, NULL, NULL, 674555849, '140 rue Marcadet', 'Paris', 75018, 'France', NULL, '2015-03-18 17:59:58'),
(4, NULL, 'LE PETIT', 'Etienne', 'etiennelepetit92@gmail.com', '0a5b3913cbc9a9092311630e869b4442', NULL, NULL, NULL, NULL, 123456578, '100 rue du la troue', 'Paris', 10017, 'France', NULL, '2015-03-19 14:12:10'),
(5, 'Mr.', 'test', 'test', 'test@test.com', '098f6bcd4621d373cade4e832627b4f6', 'test', 'test', 75008, 'France', 606060606, 'test', 'Paris', 75008, 'France', NULL, '2015-03-19 16:05:32'),
(6, NULL, 'Chapeau', 'Chapie', 'chap@mail.fr', 'f71dbe52628a3f83a77ab494817525c6', NULL, NULL, NULL, NULL, 607080910, 'Rue bourse', 'Paris', 75002, 'France', NULL, '2015-03-19 17:08:41'),
(7, NULL, 'Dev', 'Weyoz', 'weyoz.dev@gmail.com', 'ffc1c1c5351b15cc73933fb96c961a3d', NULL, NULL, NULL, NULL, 711111111, '3 rue du paradis', 'terre', 13000, 'France', NULL, '2015-03-20 02:11:35'),
(8, '', 'periquet', 'florian', 'florian.periquet@etudiant-eemi.com', '6ca08d884fb94df9600a84debc33ca5c', 'Rue de la bourse', 'Paris', 75002, 'console1', 678453425, 'Rue de la bourse', 'Paris', 75002, 'France', NULL, '2015-03-20 10:52:24');
...
--
-- Index pour la table `vr_admin`
--
ALTER TABLE `vr_admin`
 ADD PRIMARY KEY (`id_admin`), ADD UNIQUE KEY `mail_admin_UNIQUE` (`mail_admin`);

--
-- Index pour la table `vr_blog_articles`
--
ALTER TABLE `vr_blog_articles`
 ADD PRIMARY KEY (`id_article`);

--
-- Index pour la table `vr_blog_articles_has_vr_blog_categorie`
--
ALTER TABLE `vr_blog_articles_has_vr_blog_categorie`
 ADD PRIMARY KEY (`vr_blog_articles_id_article`,`vr_blog_categorie_id_blog_categorie`), ADD KEY `fk_vr_blog_articles_has_vr_blog_categorie_vr_blog_categorie_idx` (`vr_blog_categorie_id_blog_categorie`), ADD KEY `fk_vr_blog_articles_has_vr_blog_categorie_vr_blog_articles1_idx` (`vr_blog_articles_id_article`);

--
-- Index pour la table `vr_blog_categorie`
--
ALTER TABLE `vr_blog_categorie`
 ADD PRIMARY KEY (`id_blog_categorie`);

--
-- Index pour la table `vr_blog_comment`
--
ALTER TABLE `vr_blog_comment`
 ADD PRIMARY KEY (`id_comment`), ADD KEY `fk_vr_blog_comment_vr_user1_idx` (`vr_user_id_user`), ADD KEY `fk_vr_blog_comment_vr_blog_articles1_idx` (`vr_blog_articles_id_article`);

--
-- Index pour la table `vr_commandes`
--
ALTER TABLE `vr_commandes`
 ADD PRIMARY KEY (`id_commande`), ADD UNIQUE KEY `ref_commande_UNIQUE` (`ref_commande`), ADD KEY `fk_vr_commandes_vr_user_idx` (`vr_user_id_user`), ADD KEY `fk_vr_commandes_vr_prod_console1_idx` (`vr_prod_console_id_console`);

--
-- Index pour la table `vr_commandes_has_vr_prod_jeux`
--
ALTER TABLE `vr_commandes_has_vr_prod_jeux`
 ADD PRIMARY KEY (`vr_commandes_id_commande`,`vr_prod_jeux_id_jeux`), ADD KEY `fk_vr_commandes_has_vr_prod_jeux_vr_prod_jeux1_idx` (`vr_prod_jeux_id_jeux`), ADD KEY `fk_vr_commandes_has_vr_prod_jeux_vr_commandes1_idx` (`vr_commandes_id_commande`);

--
-- Index pour la table `vr_contact`
--
ALTER TABLE `vr_contact`
 ADD PRIMARY KEY (`id_contact`);

--
-- Index pour la table `vr_newsletter`
--
ALTER TABLE `vr_newsletter`
 ADD PRIMARY KEY (`id_newsletter`), ADD UNIQUE KEY `email_newsletter_UNIQUE` (`email_newsletter`);

--
-- Index pour la table `vr_prod_console`
--
ALTER TABLE `vr_prod_console`
 ADD PRIMARY KEY (`id_console`), ADD UNIQUE KEY `ref_console_UNIQUE` (`ref_console`);

--
-- Index pour la table `vr_prod_jeux`
--
ALTER TABLE `vr_prod_jeux`
 ADD PRIMARY KEY (`id_jeux`), ADD UNIQUE KEY `ref_console_UNIQUE` (`ref_jeux`), ADD KEY `fk_vr_prod_jeux_vr_prod_console1_idx` (`vr_prod_console_id_console`);

--
-- Index pour la table `vr_rachat`
--
ALTER TABLE `vr_rachat`
 ADD PRIMARY KEY (`id_rachat`);

--
-- Index pour la table `vr_user`
--
ALTER TABLE `vr_user`
 ADD PRIMARY KEY (`id_user`), ADD UNIQUE KEY `mail_user_UNIQUE` (`mail_user`);
...
--
-- AUTO_INCREMENT pour la table `vr_admin`
--
ALTER TABLE `vr_admin`
MODIFY `id_admin` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT pour la table `vr_blog_articles`
--
ALTER TABLE `vr_blog_articles`
MODIFY `id_article` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT pour la table `vr_blog_categorie`
--
ALTER TABLE `vr_blog_categorie`
MODIFY `id_blog_categorie` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `vr_blog_comment`
--
ALTER TABLE `vr_blog_comment`
MODIFY `id_comment` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `vr_commandes`
--
ALTER TABLE `vr_commandes`
MODIFY `id_commande` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT pour la table `vr_contact`
--
ALTER TABLE `vr_contact`
MODIFY `id_contact` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pour la table `vr_newsletter`
--
ALTER TABLE `vr_newsletter`
MODIFY `id_newsletter` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT pour la table `vr_prod_console`
--
ALTER TABLE `vr_prod_console`
MODIFY `id_console` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT pour la table `vr_prod_jeux`
--
ALTER TABLE `vr_prod_jeux`
MODIFY `id_jeux` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=65;
--
-- AUTO_INCREMENT pour la table `vr_rachat`
--
ALTER TABLE `vr_rachat`
MODIFY `id_rachat` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `vr_user`
--
ALTER TABLE `vr_user`
